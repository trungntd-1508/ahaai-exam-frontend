        ...
        <div class="mt-4">
          ...
          <div class="col-12 mt-sm-0">
            ...
            <ArgonInput
              ...
              type="password"
              placeholder="******"
              :error="isError('passwordConfirm', passwordErrorsRef)"
              :error-message="
                getErrorMessage('passwordConfirm', passwordErrorsRef)
              "
            />
          </div>
          <div class="button-row d-flex mt-4">
...
const handleProfileErrors = () => {
  ...
  if (!newEmail.value) {
    errorsRef.value = [
      ...errorsRef.value,
      { $property: "email", $message: "The email field is required." },
    ];
  }
};
...
const handlePasswordErrors = () => {
  ...
  if (!password.value) {
    passwordErrorsRef.value = [
      ...passwordErrorsRef.value,
      { $property: "password", $message: "The password field is required." },
    ];
  }
  ...
  if (password.value !== passwordConfirm.value) {
    passwordErrorsRef.value = [
      ...passwordErrorsRef.value,
      { $property: "passwordConfirm", $message: "Passwords don't match." },
    ];
  }
};
</script>
